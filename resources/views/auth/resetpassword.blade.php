...
<p><span id="9999" style="display: none !important; font-size:0; line-height:0"> </span></p>
    ...
    <tr>
        <td align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
            <table cellpadding="0" cellspacing="0" class="content"
                ...
                <tr>
                    <td class="header"
                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center; background: #222831;">
                        <a href="https://www.laravist.com"
                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #FFF; font-size: 20px; font-weight: bold; text-decoration: none;"
                           target="_blank">{{env('APP_NAME')}}-做最好的问答社区 </a></td>
                </tr>
                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a class="button button-blue"
                                                                           href="{{$url}}"
                                                                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #FFF; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; background-color: #00adb5; border-top: 10px solid #00adb5; border-right: 18px solid #00adb5; border-bottom: 10px solid #00adb5; border-left: 18px solid #00adb5;"
                                                                           target="_blank">激活我的账号</a></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                            ...
                            <tr>
                                <td align="center" class="content-cell"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">
                                        © 2017 . All rights reservurl8585435ed.</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<div style="text-align:center">
    <div style="border-top:1px solid #ddd;width: 600px;display:inline-block;padding:10px"><a
                ...
                href=""
                target="_blank">点击这里取消订阅<br>click to unsubscribe</a></div>
</div>
